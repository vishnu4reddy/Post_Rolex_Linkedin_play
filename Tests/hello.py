...
class LoginPage:
    ...
    def select_repository(self, repository_name: str):
        self.page.locator("(//button[@name='button'][normalize-space()='Show more'])[1]").click()
        self.page.locator(f"//ul[2]//li[4]//div[1]//div[1]//a[contains(text(), '{repository_name}')]").click()
    ...
    def open_test_file(self, file_name: str):
        ...
        self.page.locator("//remote-clipboard-copy[@class='d-inline-block btn-octicon']").click()
    ...
    def open_codespace(self):
        ...
        self.page.locator("//button[@data-action='click:options-popover#showEditors']").click()
        self.page.locator("//span[normalize-space()='Open in browser']").click()
